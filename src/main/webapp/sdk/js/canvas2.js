    ...
    var submodules = function() {
      ...
      var frame = function() {
        return{size:function() {
          ...
          if(size === undefined){
        	  alert("something is wrong with the size argument");
          }else{
        	  alert("here is what I was passed " +JSON.stringify(size));
          }
          alert("You've called a resize with " + size.height + " " + size.width);
          if($$.isNil(size)) {
        	  alert("size is nill");
